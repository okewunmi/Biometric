...
export default function OptimizedExamVerification() {
  ...
  // ⚠️ CRITICAL: Update this to your Next.js server URL!
  // This is NOT your Appwrite URL
  
  // For local development (your computer's IP):
  const API_BASE_URL = 'http://192.168.43.123:3000'; 
  // ☝️ CHANGE THIS to match your computer's local IP
  ...
  const loadFaceRecognition = async () => {
    try {
      ...
      setErrorMessage(`Cannot connect to API at ${API_BASE_URL}. Is your Next.js server running?`);
    }
  };
